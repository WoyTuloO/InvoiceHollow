 ...
 * @author wojte
 */
public class PastInvoiceButtonTile extends JButton {
    Dimension size = new Dimension(210,340);

    public PastInvoiceButtonTile(){
    ...
    public void blueprintSetup(String blueprintName){
        setText(blueprintName);
        ImageIcon iconInvoice = new ImageIcon (getClass().getResource("/Images/blueprintsIcon.png"));
        Image imgInvoice = iconInvoice.getImage().getScaledInstance(92, 92,  java.awt.Image.SCALE_SMOOTH);
        this.setIcon(new ImageIcon(imgInvoice));
    }
    
    public void lastInvoiceSetup(String number){
        setText(number);
        ImageIcon iconInvoice = new ImageIcon (getClass().getResource("/Images/InvoiceIcon.png"));
        Image imgInvoice = iconInvoice.getImage().getScaledInstance(92, 92,  java.awt.Image.SCALE_SMOOTH);
        this.setIcon(new ImageIcon(imgInvoice));
